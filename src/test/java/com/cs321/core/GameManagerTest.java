...
public class GameManagerTest {
    ...
    /**
     * progressRound finishes and accepts a round when score is done before throws and isExactZeroWin is false.
     */
    @Test
    public void progressRoundFinishesAndAcceptsRoundWithScoreDoneBeforeThrowsWithoutExactZeroWin() {
        String playername1 = "p1";
        String playername2 = "p2";
        String playername3 = "p3";
        String playername4 = "p4";
        ...
        gameManager.beginRound();
        gameManager.progressRound(100);
        assertNull(gameManager.getCurrentRound());
        assertEquals(gameManager.getRoundsManager().getTotalRounds(), 1);
        assertEquals(gameManager.getRoundsManager().getRounds()[0].getTotalThrows(), 1);
    }

    /**
     * progressRound finishes and accepts a round when score overshoots before throws and isExactZeroWin is false.
     */
    @Test
    public void progressRoundFinishesAndAcceptsRoundWithScoreOvershootBeforeThrowsWithoutExactZeroWin() {
        String playername1 = "p1";
        String playername2 = "p2";
        String playername3 = "p3";
        String playername4 = "p4";
    ...
    /**
     * progressRound finishes and rejects a round when score overshoots before throws and isExactZeroWin is true.
     */
    @Test
    public void progressRoundFinishesAndRejectsRoundWithScoreOvershootBeforeThrowsWithExactZeroWin() {
        String playername1 = "p1";
        String playername2 = "p2";
        String playername3 = "p3";
        String playername4 = "p4";
        ...
        gameManager.progressRound(101);
        assertNull(gameManager.getCurrentRound());
        assertEquals(gameManager.getRoundsManager().getTotalRounds(), 0);
    }
